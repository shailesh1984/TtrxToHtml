...
public class GenerateTrxReportService : IGenerateTrxReportService
{
    ...
    {
        ArgumentNullException.ThrowIfNull(trxReport);
        ArgumentNullException.ThrowIfNull(appSettings);
        ArgumentNullException.ThrowIfNull(commandLineInterfaceValues);
        ...
        DirectoryInfo sourceContentsDir = new(sourceContentsPath);
